...
class CrossWordsPuzzleGenerator:
    def __init__(self,
        ...
        self.cross_words_puzzle_resolved_file_path = f"Puzzles/{domain}_cross_words_file(solved).xpf"
...
if __name__ == '__main__':
    ...
    words, clues = get_words_and_clues(domain)

    cross_words_puzzle_generator = CrossWordsPuzzleGenerator(domain, words, clues)
